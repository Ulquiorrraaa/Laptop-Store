        ...
        <div class="create-card">
            <form action="/admin/products" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="processor" name="processor" class="form-control"
                            value="{{ old('processor') }}" placeholder="e.g. Intel i9" required>
                        @error('processor')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ram" name="ram" class="form-control"
                            value="{{ old('ram') }}" placeholder="e.g. 16GB" required>
                        @error('ram')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="storage" name="storage" class="form-control"
                            value="{{ old('storage') }}" placeholder="e.g. 1TB SSD" required>
                        @error('storage')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="display" name="display" class="form-control"
                            value="{{ old('display') }}" placeholder="e.g. 15.6 inch 4K" required>
                        @error('display')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="image-upload-box">
                    ...
                    <label for="image" style="font-size: 0.85rem; font-weight: 600; color: #6c757d;">Option A: Upload
                        File</label>
                    ...
                    <label for="image_url" style="font-size: 0.85rem; font-weight: 600; color: #6c757d;">Option B: Paste
                        Image Link</label>
